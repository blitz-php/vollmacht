...
class AccessToken implements ScopeAuthorizable, Arrayable, Jsonable, JsonSerializable
{
    ...
    public function revoke(): bool
    {
        ...
        if (isset($this->attributes['oauth_access_token_id'])) {
            return (bool) Vollmacht::token()->newQuery()->whereKey($this->attributes['oauth_access_token_id'])->update(['revoked' => true]);
        }
    ...
    protected function getToken(): ?Token
    {
        ...
        if (isset($this->attributes['oauth_access_token_id'])) {
            return $this->token = Vollmacht::token()->newQuery()->find($this->attributes['oauth_access_token_id']);
        }
